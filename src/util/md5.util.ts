export class MD5Util {
    ...
    public static hashStr(str: string): string {    
        let x = Array();
        ...
        let temp = MD5Util.WordToHex(a) + MD5Util.WordToHex(b) + MD5Util.WordToHex(c) + MD5Util.WordToHex(d);
    ...
    private static RotateLeft(lValue, iShiftBits) {
      ...
      private static Utf8Encode(str: string) {
        str = str.replace(/\r\n/g, "\n");
        let utftext = "";
