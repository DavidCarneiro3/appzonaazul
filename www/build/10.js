...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__profile__ = __webpack_require__(815);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_modal_modal__ = __webpack_require__(198);
...
var ProfilePage = /** @class */ (function () {
    function ProfilePage(navCtrl, navParams, alertCtrl, loadingCtrl, actionSheetCtrl, modalCtrl, modalProvider, userProvider, authProvider) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.alertCtrl = alertCtrl;
        this.loadingCtrl = loadingCtrl;
        ...
        this.userProvider.getUserLocal().then(function (userID) {
            ...
            if (userID != null) {
                _this.subCurrentUser = _this.userProvider.byId(userID).subscribe(function (user) {
                    _this.user = new __WEBPACK_IMPORTED_MODULE_2__models_user__["a" /* User */](user);
                });
            }
        });
    };
    ...
    ProfilePage.prototype.showAlert = function (title, msg, type, callback) {
        this.alertCtrl.create({
            title: title,
            message: msg,
            cssClass: type,
    ...
    ProfilePage.prototype.openPerfilEditar = function () {
        var profileEdit = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_9__environments_constants__["a" /* Constants */].PROFILE_EDIT_PAGE.name, { user: this.user });
        profileEdit.present();
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('fileUserPhoto'),
        __metadata("design:type", Object)
    ], ProfilePage.prototype, "fileUserPhoto", void 0);
    ProfilePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-profile',template:/*ion-inline-start:"/Users/desenvolvedor/Documents/zonaazulfortaleza-develop/src/pages/profile/profile.html"*/'<ion-header no-border>\n  <ion-navbar transparent>\n    <button ion-button icon-only menuToggle>\n      <ion-icon class="header-icon" name="menu"></ion-icon>\n    </button>\n\n    <ion-title>\n      <ion-label>Perfil</ion-label>\n    </ion-title>\n\n    <ion-buttons end>\n      <button ion-button icon-only (click)="openPerfilEditar()">\n        <ion-icon class="header-icon" name="icon-preferencias"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content class="content">\n  <ion-grid class="grid-profile">\n    <ion-thumbnail class="centralize">\n      <div class="profile-img">\n        <div>\n          <img src="{{user?.photo}}" class="img">\n        </div>\n      </div>\n    </ion-thumbnail>\n\n    <ion-row class="informacoes-header">\n      <ion-item no-lines>\n        <h4 class="text-name">{{user?.name}}</h4>\n        <h6 class="text-email">{{user?.email}}</h6>\n      </ion-item>\n    </ion-row>\n    <ion-row class="informacoes-body">\n      <ion-item class="btn-row">\n        <button ion-button (click)="showConfirm()" class="btn btn-password">Alterar a senha</button>\n      </ion-item>\n      <ion-item class="informacoes-body-header" mode="ios">\n        <ion-label class="title-header-body">INFORMAÇÕES DO USUÁRIO</ion-label>\n      </ion-item>\n      <ion-list class="informacoes-body-list" mode="ios">\n        <ion-item class="informacoes-body-list-item">\n          <h6>Nome</h6>\n          <h2>{{user?.name}}</h2>\n        </ion-item>\n        <ion-item class="informacoes-body-list-item">\n          <h6>Data de Nascimento</h6>\n          <h2>{{user?.dateOfBirth | date: "dd/MM/yyyy"}}</h2>\n        </ion-item>\n        <ion-item class="informacoes-body-list-item">\n          <h6>Email</h6>\n          <h2>{{user?.email}}</h2>\n        </ion-item>\n        <ion-item class="informacoes-body-list-item">\n          <h6>Telefone</h6>\n          <h2>{{user?.phone}}</h2>\n        </ion-item>\n        <ion-item class="informacoes-body-list-item">\n          <h6>Sexo</h6>\n          <h2>{{user?.sex}}</h2>\n        </ion-item>\n      </ion-list>\n    </ion-row>\n  </ion-grid>\n\n</ion-content>'/*ion-inline-end:"/Users/desenvolvedor/Documents/zonaazulfortaleza-develop/src/pages/profile/profile.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */],
            ...
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* ModalController */],
            __WEBPACK_IMPORTED_MODULE_6__providers_modal_modal__["a" /* ModalProvider */],
