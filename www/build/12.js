...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PagamentosPageModule", function() { return PagamentosPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pagamentos__ = __webpack_require__(811);
...
var PagamentosPageModule = /** @class */ (function () {
    function PagamentosPageModule() {
    }
    PagamentosPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__pagamentos__["a" /* PagamentosPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__pagamentos__["a" /* PagamentosPage */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_pagamentos_pagamentos__ = __webpack_require__(424);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__util_map_util__ = __webpack_require__(770);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PagamentosPage = /** @class */ (function () {
    function PagamentosPage(navCtrl, viewCtrl, navParams, alertCtrl, loadingCtrl, userProvider, pagamentosProvider) {
        this.navCtrl = navCtrl;
        ...
        __WEBPACK_IMPORTED_MODULE_5__util_map_util__["a" /* MapUtil */].circles.pop();
    }
    PagamentosPage.prototype.ionViewCanEnter = function () {
        this.userProvider.getUserLocal().then(function (userID) {
            if (userID) {
                return true;
            }
    ...
    PagamentosPage.prototype.ionViewDidEnter = function () {
        this.fromPage = this.navParams.get('fromPage');
        var goPage = this.navParams.get('gotoPage');
    ...
    PagamentosPage.prototype.carregaCartoes = function () {
        var _this = this;
        this.userProvider.getUserLocal().then(function (userID) {
            if (userID != null) {
                _this.userProvider.byId(userID).take(1).subscribe(function (user) {
    ...
    PagamentosPage.prototype.ionViewWillLeave = function () {
    };
    PagamentosPage.prototype.ionViewDidLeave = function () {
    };
    PagamentosPage.prototype.ionViewWillUnload = function () {
    };
    PagamentosPage.prototype.ionViewCanLeave = function () {
    };
    PagamentosPage.prototype.openPage = function (event, item, key) {
        event.preventDefault();
        this.navCtrl.push('PagamentosFormPage', { 'item': item, 'user': this.user, 'pgtoAllArr': this.list, 'fromPage': this.fromPage });
    };
    PagamentosPage.prototype.getCartaoNumeroFormat = function (numero) {
    ...
    PagamentosPage.prototype.excluir = function (event, cartaoId) {
        var _this = this;
        event.stopPropagation();
        this.onConfirm(function () {
            _this.pagamentosProvider.remove(_this.user.id, cartaoId).then(function (_) {
                _this.carregaCartoes();
            });
        });
    };
    PagamentosPage.prototype.onConfirm = function (success) {
        this.alertCtrl.create({
            title: 'Excluir',
    ...
    PagamentosPage.prototype.loadImageCartao = function (numero) {
    ...
    PagamentosPage.prototype.showAlert = function (title, msg, type, callback) {
        var alert = this.alertCtrl.create({
            title: title,
            message: msg,
            cssClass: type,
    ...
    PagamentosPage.prototype.openHelp = function () {
        this.showAlert('Ajuda', 'Adicione uma nova forma de pagamento comprar seus CADs. Você pode também visualizar, alterar ou excluir uma forma de pagamento já existente.', '', function () { });
    };
    PagamentosPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-pagamentos',template:/*ion-inline-start:"/Users/desenvolvedor/Documents/zonaazulfortaleza-develop/src/pages/pagamentos/pagamentos.html"*/'<ion-header no-border>\n    <ion-navbar color="header">\n        <button ion-button icon-only menuToggle>\n            <ion-icon class="header-icon" name="menu"></ion-icon>\n        </button>\n\n        <ion-title class="header-title">Pagamento</ion-title>\n\n        <ion-buttons end>\n            <button ion-button icon-only (click)="openHelp()">\n                <ion-icon name="help-circle" class="header-icon"></ion-icon>\n            </button>\n        </ion-buttons>\n\n    </ion-navbar>\n</ion-header>\n\n<ion-content padding class="content">\n    <button ion-button (click)="openPage($event)" class="btn" block> + Adicionar Cartão de Crédito </button>\n    <loading-spinner *ngIf="showSpinner"></loading-spinner>\n    <ion-list *ngIf="!showSpinner" class="list">\n        <ion-item detail-none *ngFor="let current of list" (click)="openPage($event, current, current.key)" no-lines\n            class="route-item">\n            <ion-thumbnail item-start class="thumbnail-icon">\n                <img src="{{loadImageCartao(current?.values?.numero)}}" />\n            </ion-thumbnail>\n            <h2 class="information-date">{{getCartaoNumeroFormat(current?.values?.numero)}}</h2>\n            <p class="information-hour">{{current?.values?.data | date: \'MM/yyyy\'}} </p>\n            <button ion-button class="btn-cancel" outline item-end (click)="excluir($event,current?.key)">Excluir</button>\n        </ion-item>\n    </ion-list>\n</ion-content>'/*ion-inline-end:"/Users/desenvolvedor/Documents/zonaazulfortaleza-develop/src/pages/pagamentos/pagamentos.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_2__providers_pagamentos_pagamentos__["a" /* PagamentosProvider */]])
    ], PagamentosPage);
