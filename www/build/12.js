...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pagamentos__ = __webpack_require__(870);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_pagamentos_pagamentos__ = __webpack_require__(453);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__util_map_util__ = __webpack_require__(834);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PagamentosPage = /** @class */ (function () {
    function PagamentosPage(navCtrl, navParams, alertCtrl, loadingCtrl, userProvider, pagamentosProvider) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.alertCtrl = alertCtrl;
        this.loadingCtrl = loadingCtrl;
    ...
    PagamentosPage.prototype.openHelp = function () {
        this.showAlert('Ajuda', 'Clique na forma de pagamento para ver e editar as informações ou adicione uma nova.', '', function () { });
    };
    PagamentosPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-pagamentos',template:/*ion-inline-start:"/Users/desenvolvedor/Documents/appzonzazul/src/pages/pagamentos/pagamentos.html"*/'<ion-header no-border>\n    <ion-navbar color="header">\n        <button ion-button icon-only menuToggle>\n            <ion-icon class="header-icon" name="menu"></ion-icon>\n        </button>\n\n        <ion-title>\n            <ion-label>Meus Cartões</ion-label>\n        </ion-title>\n\n        <ion-buttons end>\n            <button ion-button icon-only (click)="openHelp()">\n                <ion-icon name="help-circle" class="header-icon"></ion-icon>\n            </button>\n        </ion-buttons>\n\n    </ion-navbar>\n</ion-header>\n\n<ion-content padding class="content">\n    <button ion-button (click)="openPage($event)" class="btn" block>+ Adicionar Cartão</button>\n    <loading-spinner *ngIf="showSpinner"></loading-spinner>\n    <ion-list *ngIf="!showSpinner">\n        <ion-item detail-none *ngFor="let current of list | async" (click)="openPage($event, current, current.key)"\n            class="route-item">\n            <ion-thumbnail item-start class="thumbnail-icon">\n                <img src="{{loadImageCartao(current?.values?.numero)}}" />\n            </ion-thumbnail>\n            <h2 class="information-date">{{getCartaoNumeroFormat(current?.values?.numero)}}</h2>\n            <p class="information-hour">{{current?.values?.data | date: \'MM/yyyy\'}} </p>\n            <button ion-button color="grey" outline item-end (click)="excluir($event,current?.key)">Excluir</button>\n        </ion-item>\n    </ion-list>\n</ion-content>'/*ion-inline-end:"/Users/desenvolvedor/Documents/appzonzazul/src/pages/pagamentos/pagamentos.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */],
