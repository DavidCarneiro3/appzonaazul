...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pagamentos_form__ = __webpack_require__(814);
...
var PagamentosFormPageModule = /** @class */ (function () {
    function PagamentosFormPageModule() {
    }
    PagamentosFormPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__pagamentos_form__["a" /* PagamentosFormPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_3_brmasker_ionic_3__["a" /* BrMaskerModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__pagamentos_form__["a" /* PagamentosFormPage */]),
            ],
        })
    ], PagamentosFormPageModule);
    return PagamentosFormPageModule;
}());

//# sourceMappingURL=pagamentos-form.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__models_pagamento__ = __webpack_require__(438);
...
var PagamentosFormPage = /** @class */ (function () {
    ...
    PagamentosFormPage.prototype.ionViewCanEnter = function () {
        this.userProvider.getUserLocal().then(function (userID) {
            if (userID) {
                return true;
            }
    ...
    PagamentosFormPage.prototype.ionViewWillLeave = function () {
    };
    PagamentosFormPage.prototype.scan = function () {
        var _this = this;
        this.cardIO.canScan()
            .then(function (res) {
            if (res) {
                ...
                var loading_1 = _this.showLoading();
                _this.cardIO.scan(options)
                    .then(function (data) {
                    _this.item.nome = data.cardholderName;
                    _this.item.numero = data.cardNumber;
                    if (data.cvv) {
                        _this.item.ccv = data.cvv;
                    }
                    if (data.expiryMonth < 10) {
                        _this.item.data = data.expiryYear + '-' + '0' + data.expiryMonth;
                    }
                    else {
                        _this.item.data = data.expiryYear + '-' + data.expiryMonth;
                    }
                    // this.showAlert('Sucesso', 'Dados do cartão obtidos com sucesso!', 'alert', () => {
                    _this.numero.setFocus();
                    loading_1.dismiss();
                    // });
                }).catch(function (error) {
            ...
            .catch(function (error) {
            _this.showAlert('Olá', 'Você precisa autorizar a aplicação para utilizar este recurso.', '', function () { });
        });
    };
    ...
    PagamentosFormPage.prototype.showAlert = function (title, message, type, callback) {
        this.alertCtrl.create({
            title: title,
            message: message,
            cssClass: type,
...
//# sourceMappingURL=pagamentos-form.js.map
