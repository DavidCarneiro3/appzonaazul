...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ComprarCreditosPageModule", function() { return ComprarCreditosPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pipes_pipes_module__ = __webpack_require__(457);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__comprar_creditos__ = __webpack_require__(852);
...
var ComprarCreditosPageModule = /** @class */ (function () {
    function ComprarCreditosPageModule() {
    }
    ComprarCreditosPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__comprar_creditos__["a" /* ComprarCreditosPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_0__pipes_pipes_module__["a" /* PipesModule */],
                __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__comprar_creditos__["a" /* ComprarCreditosPage */]),
            ],
        })
    ], ComprarCreditosPageModule);
    return ComprarCreditosPageModule;
}());

//# sourceMappingURL=comprar-creditos.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ComprarCreditosPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models_user__ = __webpack_require__(134);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_cads_cads__ = __webpack_require__(133);
...
var ComprarCreditosPage = /** @class */ (function () {
    function ComprarCreditosPage(navCtrl, navParams, alertCtrl, loadingCtrl, userProvider, cadProvider) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.alertCtrl = alertCtrl;
        this.loadingCtrl = loadingCtrl;
        ...
        __WEBPACK_IMPORTED_MODULE_7__util_map_util__["a" /* MapUtil */].circles.pop();
    }
    ComprarCreditosPage.prototype.ionViewCanEnter = function () {
        var _this = this;
        var loading = this.loadingCtrl.create({ content: 'Aguarde...' });
        loading.present();
        this.userProvider.getUserLocal().then(function (userID) {
            if (userID) {
                _this.userProvider.byId(userID).take(1).subscribe(function (_user) {
                    _this.user = new __WEBPACK_IMPORTED_MODULE_2__models_user__["a" /* User */](_user);
                    loading.dismiss();
                });
                return true;
            }
    ...
    ComprarCreditosPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        ...
        this.cadProvider.find().take(1).subscribe(function (item) {
            item.map(function (item) {
                ...
                if (_this.cad.gateway === 'pagarme') {
                    _this.cielo = false;
                    __WEBPACK_IMPORTED_MODULE_9__environments_environment__["a" /* environment */].cielo = false;
                }
                else {
                    _this.cielo = true;
                    __WEBPACK_IMPORTED_MODULE_9__environments_environment__["a" /* environment */].cielo = true;
                }
            });
        });
    };
    ComprarCreditosPage.prototype.ionViewWillLeave = function () {
    };
    ComprarCreditosPage.prototype.selecionarQtd = function (value) {
        this.cads += value;
        this.price += value * this.cad.valor_unitario;
        this.desconto = (this.user.percent / 100) * this.cad.valor_unitario * this.cads;
    };
    ComprarCreditosPage.prototype.clean = function () {
        this.cads = 0;
        this.price = 0;
        this.desconto = 0;
    };
    ComprarCreditosPage.prototype.formaPagamento = function () {
        var _this = this;
        var precoComDesconto = (this.price - this.desconto);
        var precoComDescontoAbs = parseInt(precoComDesconto.toString());
        if (!__WEBPACK_IMPORTED_MODULE_9__environments_environment__["a" /* environment */].cielo && (precoComDesconto - precoComDescontoAbs !== 0)) {
            this.showAlert("Aviso!", "Precisamos fechar em um valor inteiro, isto é, 0 (zero) centavos.", "", function () { });
            return;
        }
        if (this.price > 0 && this.cads > 0) {
            ...
            if (!this.cielo) {
                ...
                alert_1.setTitle('Escolha a forma de pagamento');
                alert_1.addInput({
                    type: 'radio',
            ...
            this.showAlert("Aviso!", "É preciso selecionar pelo menos 1 CAD para a comprar", "info", function () {
            });
        }
    };
    ComprarCreditosPage.prototype.comprar = function (method) {
        if (this.fromPage == 'estacionar') {
            this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_8__environments_constants__["a" /* Constants */].CREDITOS_PAGAMENTO_PAGE.name, {
    ...
    ComprarCreditosPage.prototype.showAlert = function (title, msg, type, callback) {
        var alert = this.alertCtrl.create({
            title: title,
            message: msg,
            cssClass: type,
    ...
    return ComprarCreditosPage;
}());

//# sourceMappingURL=comprar-creditos.js.map
