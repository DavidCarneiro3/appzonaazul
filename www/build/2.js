...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__tempo_restante__ = __webpack_require__(881);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_cads_user_cads_user__ = __webpack_require__(218);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__models_veiculo__ = __webpack_require__(449);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_rxjs_add_observable_interval__ = __webpack_require__(839);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_rxjs_add_operator_take__ = __webpack_require__(93);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__environments_constants__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__app_app_component__ = __webpack_require__(440);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__util_map_util__ = __webpack_require__(834);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__providers_logger_logger__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__providers_modal_modal__ = __webpack_require__(216);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TempoRestantePage = /** @class */ (function () {
    function TempoRestantePage(navCtrl, navParams, viewCtrl, userProvider, estacionarProvider, tempoEstacionadoProvider, veiculoProvider, setorProvider, logger, cadsUserProvider, alertCtrl, platform, modalProvider) {
        var _this = this;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        ...
        this.platform.resume.subscribe(function (event) {
            _this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_11__environments_constants__["a" /* Constants */].TEMPO_RESTANTE_PAGE.name);
        });
    }
    ...
    TempoRestantePage.prototype.ionViewDidLoad = function () {
        ...
        this.tempoEstacionadoProvider.getHoraAtualFromFirebase().then(function (data) {
            _this.logger.info('now: ' + JSON.stringify(data));
            _this.userProvider.getUserLocal().then(function (userID) {
                if (userID) {
                    ...
                    _this.estacionarProvider.findByUser(userID).take(1).subscribe(function (_values) {
                        _this._estacionados = [];
                        if (_values.length > 0) {
