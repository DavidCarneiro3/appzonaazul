...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__veiculos_form__ = __webpack_require__(825);
...
var VeiculosFormPageModule = /** @class */ (function () {
    function VeiculosFormPageModule() {
    }
    VeiculosFormPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__veiculos_form__["a" /* VeiculosFormPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__veiculos_form__["a" /* VeiculosFormPage */]),
                __WEBPACK_IMPORTED_MODULE_3_angular2_text_mask__["TextMaskModule"],
            ]
        })
    ], VeiculosFormPageModule);
    return VeiculosFormPageModule;
}());

//# sourceMappingURL=veiculos-form.module.js.map
...
var VeiculosFormPage = /** @class */ (function () {
    function VeiculosFormPage(navCtrl, navParams, platform, loadingCtrl, alertCtrl, userProvider, logger, veiculosProvider) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.platform = platform;
        this.loadingCtrl = loadingCtrl;
    ...
    VeiculosFormPage.prototype.ionViewCanEnter = function () {
        this.userProvider.getUserLocal().then(function (userID) {
            if (userID) {
                return true;
            }
    ...
    VeiculosFormPage.prototype.ionViewDidEnter = function () {
        var _this = this;
        this.veiculosProvider.getTiposVeiculo().take(1).subscribe(function (items) {
            items.forEach(function (item) {
                _this.tipos_veiculo.push(item.tipo);
            });
        });
    };
    VeiculosFormPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        ...
        if (itemTmp) {
            ...
            this.item = new __WEBPACK_IMPORTED_MODULE_2__models_veiculo__["a" /* VeiculoModel */](parseTmp.veiculo);
            this.item.id = parseTmp.key;
            this.logger.info('user: ' + this.userId);
            this.logger.info('veiculo: ' + JSON.stringify(this.item));
            console.log(this.item);
        }
        this.userProvider.byId(this.userId).take(1).subscribe(function (item) {
    ...
    VeiculosFormPage.prototype.ionViewWillLeave = function () { };
    VeiculosFormPage.prototype.formatPlaca = function (placa) {
        if (placa.length <= 3) {
     ...
     */
    VeiculosFormPage.prototype.isMercosul = function () {
        var regexPlacaMercosul = /^[a-zA-Z]{3}[-]{1}[0-9]{1}[a-zA-Z]{1}[0-9]{2}$/;
    ...
    VeiculosFormPage.prototype.close = function () {
        if (this.withMenu) {
            if (this.fromPage == 'estacionar' || this.fromPage == 'renovar') {
                this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_5__environments_constants__["a" /* Constants */].ESTACIONAR_PAGE.name, {
    ...
    VeiculosFormPage.prototype.showLoading = function () {
        var loading = this.loadingCtrl.create({ content: 'Aguarde...' });
        loading.present();
        return loading;
    };
    VeiculosFormPage.prototype.showAlert = function (title, message, type, callback) {
        this.alertCtrl.create({
            title: title,
            message: message,
            cssClass: type,
    ...
    VeiculosFormPage.prototype.hasId = function (id) {
        if (id && id !== '') {
            return true;
        }
        return false;
    ...
    return VeiculosFormPage;
}());

//# sourceMappingURL=veiculos-form.js.map
