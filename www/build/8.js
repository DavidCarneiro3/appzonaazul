...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StreatViewPageModule", function() { return StreatViewPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__streat_view__ = __webpack_require__(821);
...
var StreatViewPageModule = /** @class */ (function () {
    function StreatViewPageModule() {
    }
    StreatViewPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__streat_view__["a" /* StreatViewPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__streat_view__["a" /* StreatViewPage */])
            ],
        })
    ], StreatViewPageModule);
    return StreatViewPageModule;
}());

//# sourceMappingURL=streat-view.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return StreatViewPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_modal_modal__ = __webpack_require__(198);
...
var StreatViewPage = /** @class */ (function () {
    function StreatViewPage(navCtrl, navParams, viewCtrl, modalProvider) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.viewCtrl = viewCtrl;
        this.modalProvider = modalProvider;
        this.mapUtil = new __WEBPACK_IMPORTED_MODULE_3__util_map_util__["a" /* MapUtil */]();
        this.map = this.navParams.get('map');
        this.data = this.navParams.get('data');
        this.wait = this.navParams.get('wait');
    }
    StreatViewPage.prototype.ionViewCanEnter = function () {
    };
    StreatViewPage.prototype.ionViewWillEnter = function () {
    };
    StreatViewPage.prototype.ionViewDidLoad = function () {
        var _this = this;
    ...
    StreatViewPage.prototype.closeStreatViewPage = function () {
        var _this = this;
        this.viewCtrl.dismiss().then(function () {
            _this.modalProvider.desactivate();
        });
    };
    StreatViewPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-streat-view',template:/*ion-inline-start:"/Users/desenvolvedor/Documents/zonaazulfortaleza-develop/src/pages/streat-view/streat-view.html"*/'<ion-header no-border>\n    <ion-navbar color="header">\n\n        <ion-title style="width: 26em;">\n            <ion-label>Visualização</ion-label>\n        </ion-title>\n\n        <ion-buttons left>\n            <button ion-button (click)="closeStreatViewPage()">\n                <span color="light" class="header-text" showWhen="ios">Fechar</span>\n                <ion-icon name="md-arrow-back" class="header-icon" showWhen="android,windows,core"></ion-icon>\n            </button>\n        </ion-buttons>\n    </ion-navbar>\n</ion-header>\n<ion-content class="content">\n    <div id="streat-view"></div>\n</ion-content>'/*ion-inline-end:"/Users/desenvolvedor/Documents/zonaazulfortaleza-develop/src/pages/streat-view/streat-view.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* ViewController */],
            __WEBPACK_IMPORTED_MODULE_2__providers_modal_modal__["a" /* ModalProvider */]])
    ], StreatViewPage);
    return StreatViewPage;
}());

//# sourceMappingURL=streat-view.js.map
