...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__setores_modal__ = __webpack_require__(820);
...
var SetoresModalPageModule = /** @class */ (function () {
    ...
    SetoresModalPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__setores_modal__["a" /* SetoresModalPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__setores_modal__["a" /* SetoresModalPage */]),
            ],
        })
...
//# sourceMappingURL=setores-modal.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SetoresModalPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_area_area__ = __webpack_require__(414);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_modal_modal__ = __webpack_require__(198);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__util_map_util__ = __webpack_require__(770);
...
var SetoresModalPage = /** @class */ (function () {
    function SetoresModalPage(viewCtrl, loadingCtrl, modalCtrl, areaProvider, modalProvider, navParams) {
        ...
        this.mapUtil = new __WEBPACK_IMPORTED_MODULE_4__util_map_util__["a" /* MapUtil */]();
    }
    SetoresModalPage.prototype.ionViewWillLoad = function () {
        this.getSetores();
    };
    SetoresModalPage.prototype.getSetores = function () {
        var _this = this;
        return new Promise(function (resolve) {
            var setores = _this.navParams.get('setores');
            _this.setores = setores ? setores : [];
            _this.todosSetores = setores ? setores : [];
            _this.copiaSetores = setores ? setores : [];
            resolve(true);
        });
    };
    SetoresModalPage.prototype.select = function (item) {
        this.setorSelecionado = item;
    };
    SetoresModalPage.prototype.showSetor = function () {
        this.viewCtrl.dismiss(this.setorSelecionado);
    };
    SetoresModalPage.prototype.dismiss = function () {
        this.viewCtrl.dismiss(this.setorSelecionado);
    };
    /**
     ...
     */
    SetoresModalPage.prototype.procurarZonas = function (event) {
        var zona = event.target.value;
        if (zona) {
            if (zona.trim() === '') {
                ...
                if (this.filtradoPorBairro) {
                    this.setores = this.setoresFiltrados.filter(function (setores) {
                        return (setores.setor && setores.setor.toUpperCase().indexOf(zona.toUpperCase()) > -1);
                    });
                }
                else {
                    this.setores = this.copiaSetores.filter(function (setores) {
                        return (setores.setor && setores.setor.toUpperCase().indexOf(zona.toUpperCase()) > -1);
                    });
                }
            }
     ...
     */
    SetoresModalPage.prototype.filtrarBairros = function () {
        var _this = this;
        var wait = this.loadingCtrl.create({ content: 'Aguarde...' });
        wait.present();
        this.setoresFiltrados = [];
        this.filtradoPorBairro = false;
        this.areaProvider.getAreas().take(1).subscribe(function (_areas) {
            var areas = _areas.map(function (_area) { return { "codigo": _area.key, "endereco": _area.area.endereco }; });
            wait.dismiss();
            var areaModal = _this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_5__environments_constants__["a" /* Constants */].AREAS_MODAL_PAGE.name, { datas: areas });
            areaModal.present().then(function () {
                _this.modalProvider.setActive();
            });
            areaModal.onDidDismiss(function (data) {
                if (data) {
                    _this.todosSetores.forEach(function (item) {
                        if (item.area.codigo == data) {
                            _this.setoresFiltrados.push(item);
                        }
                    });
                    _this.filtradoPorBairro = true;
                    _this.setores = _this.setoresFiltrados;
                }
            });
        });
    };
    SetoresModalPage.prototype.limparFiltros = function () {
        this.setores = this.todosSetores;
    };
    SetoresModalPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "setores-modal",template:/*ion-inline-start:"/Users/desenvolvedor/Documents/zonaazulfortaleza-develop/src/pages/setores-modal/setores-modal.html"*/'<ion-header>\n    <ion-navbar color="header" text-center>\n\n        <ion-title center>\n            <ion-label>Setores</ion-label>\n        </ion-title>\n\n        <ion-buttons right>\n            <button ion-button (click)="filtrarBairros()">\n                <ion-icon name="funnel"></ion-icon>\n            </button>\n            <button ion-button (click)="limparFiltros()">\n                <ion-icon name="trash"></ion-icon>\n            </button>\n        </ion-buttons>\n\n        <ion-buttons left>\n            <button ion-button (click)="dismiss()">\n                <span color="light" class="header-text" showWhen="ios">Fechar</span>\n                <ion-icon name="md-close" class="header-icon" showWhen="android,windows,core"></ion-icon>\n            </button>\n        </ion-buttons>\n    </ion-navbar>\n</ion-header>\n\n<ion-content>\n    <ion-searchbar placeholder="Buscar Setores" color="secondary" (ionInput)="procurarZonas($event)"></ion-searchbar>\n    <ion-list radio-group class="list">\n        <ion-item *ngFor="let setor of setores" text-wrap>\n            <ion-label>{{setor.setor}} <br> {{setor.area.endereco}}</ion-label>\n            <ion-radio item-left slot="start" (ionSelect)="select(setor)" mode="md"></ion-radio>\n        </ion-item>\n    </ion-list>\n</ion-content>\n\n<ion-footer class="rodape">\n    <ion-toolbar mode="md">\n        <ion-title>\n            <ion-row class="btn-rows">\n                <ion-col>\n                    <button ion-button block (click)="dismiss()">Cancelar</button>\n                </ion-col>\n                <ion-col>\n                    <button ion-button block color="default" (click)="showSetor()"\n                        [disabled]="this.setorSelecionado.length <= 0"> OK </button>\n                </ion-col>\n            </ion-row>\n        </ion-title>\n    </ion-toolbar>\n</ion-footer>'/*ion-inline-end:"/Users/desenvolvedor/Documents/zonaazulfortaleza-develop/src/pages/setores-modal/setores-modal.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* ViewController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_modal_modal__["a" /* ModalProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* NavParams */]])
    ], SetoresModalPage);
    return SetoresModalPage;
}());

//# sourceMappingURL=setores-modal.js.map
